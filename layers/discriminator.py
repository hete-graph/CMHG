...
class MultiDiscriminator(nn.Module):
    ...
    def forward(self, c1, c2, h1, h2, h3, h4):
        '''
        c1: graph emb from view_1
        c2: graph emb from view_2
        h1: node emb from view_1
        h2: node emb from view_2
        h3: negative node emb from view_1
        h4: negative node emb from view_2
        '''
